...
$title = "BOLIBOX - Pedidos Externos";
$current_page = "empleado_pedidos_externos";
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <?php foreach ($resultado as $row) { 
                             $nombreAMostrar = !empty($row['producto_importar']) ? $row['producto_importar'] : (!empty($row['nombre_producto']) ? $row['nombre_producto'] : 'Compra Web / Bot');
                        ?>
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                ...
                                <form action="<?= url('empleado/pedidos/cambiar-estado') ?>" method="POST" style="display:inline;">
                                    ...
                                    <input type="hidden" name="origen" value="externos">
                                    <?php if ($row['estado'] == 1): ?>
